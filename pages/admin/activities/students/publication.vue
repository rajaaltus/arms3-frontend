          ...
          <v-card-text>
            ...
            <v-row>
              ...
              <v-col cols="12" md="9" lg="9">
                <formsPublicationForm :dataFrom="students" :publicationTypes="publicationTypes" section="Select Student from the list" />
              </v-col>
            </v-row>
          </v-card-text>
        </v-card>
      ...
      <v-tab-item>
        <v-card flat>
          <v-card-text class="px-0 py-1">
            <v-row>
              <v-col cols="12" md="12">
                <tablesActivitiesPublicationTable :reportYears="reportYears" dataFrom="STUDENT" />
              </v-col>
            </v-row>
          </v-card-text>
        </v-card>
