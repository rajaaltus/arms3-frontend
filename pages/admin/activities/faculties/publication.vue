  ...
  <div>
    <v-tabs flat background-color="#323232" color="#6ac447" dark>
      ...
      <v-tab-item>
        <v-card tile>
          <v-card-text>
            <PageHeader :title="$metaInfo.title" :reportYears="reportYears" @set-year="setReportingYear" class="ml-0 pb-0 pt-0" />
            <v-row>
              ...
              <v-col cols="12" md="9" lg="9">
                <FormsPublicationForm :dataFrom="staffs" :publicationTypes="publicationTypes" section="Select Faculty / Staff from the list" />
              </v-col>
            </v-row>
          </v-card-text>
        </v-card>
      ...
      <v-tab-item>
        <v-card flat>
          <v-card-text class="px-0 py-1">
            <v-row>
              <v-col cols="12" md="12">
                <tablesActivitiesPublicationTable :reportYears="reportYears" dataFrom="FACULTY" />
              </v-col>
            </v-row>
          </v-card-text>
        </v-card>
