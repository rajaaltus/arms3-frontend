...
export const actions = {
  ...
  async addTest({ commit }, payload) {
    await this.$axios
      .$post("/pc-diagnostic-tests", payload)
      .then((response) => {
  ...
  async addDiagnostic({ commit }, payload) {
    await this.$axios
      .$post("/pc-diagnostic-services", payload)
      .then((response) => {})
      .catch((e) => {})
      .finally(function () {});
  },
  ...
  async updateDiagnostic({ commit }, payload) {
    await this.$axios
      .$put(`/pc-diagnostic-services/${payload.id}`, payload)
      .then((response) => {})
      .catch((e) => {})
      .finally(function () {});
  },
